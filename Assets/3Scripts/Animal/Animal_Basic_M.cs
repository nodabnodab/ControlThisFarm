...
public class Animal_Basic_M : MovingObject
{
    public float minMoveTime = 1.5f;
    public float maxMoveTime = 5.0f;
    public float waitTime = 2.0f;
    public float escapeDistance = 4.5f;
    public float detectDistance = 1.7f;
    ...
    void Escape()
    {
        ...
        animator.SetBool("Walking", true); // Run 애니메이션이 없어서..
        ...
        {
            isEscaping = false;
            animator.SetBool("Walking", false); // Run 애니메이션 종료
            SetRandomState();
        }
    }
